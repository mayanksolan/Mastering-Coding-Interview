class Node {
  ...
  class BinarySearchTree {
    ...
    DFSInorder() {
      return travInOrder(this.root, []);
    }
    DFSPreorder() {
      return travPreOrder(this.root, []);
    }
    DFSPostorder() {
      return travPostOrder(this.root, []);
    }
  }
  
  function travInOrder(node, list) {
  ...
  function travPreOrder(node, list) {
    console.log(node.value);
    list.push(node.value);
    if(node.left) {
      travInOrder(node.left, list);
  ...
  function travPostOrder(node, list) {
    console.log(node.value);
    if(node.left) {
      travPostOrder(node.left, list);
    }  
    if(node.right) {
      travPostOrder(node.right, list);
    }
    list.push(node.value);
    return list;
  }
